...
def spitout(line):
    ...
    diff= pmag.Vdiff(dir2,dir1)  # 
    print '%7.1f %7.1f %7.1f %7.1f %s   %7.1f %7.1f'%(dir2[0],dir2[1], dir1[0],dir1[1],":",diff[0],diff[1])
    return diff
def main():
    """
    NAME
    ...
    DESCRIPTION
      calculates vector difference between two input directions D1,D2
    ...
    SYNTAX
        Vdiff.py [command line options] [< filename]
    ...
    if '-f' in sys.argv:
        ...
        while cont==1:
            ...
            diff= pmag.Vdiff(dir1,dir2)  # send dirs  to angle and spit out result
            print '%7.1f %7.1f %7.1f %7.1f %s   %7.1f %7.1f'%(dir2[0],dir2[1], dir1[0],dir1[1],":",diff[0],diff[1])
    else:
