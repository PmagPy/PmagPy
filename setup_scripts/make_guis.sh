...
#cp setup_scripts/setup_pmag_gui3.py .
...
#python setup_pmag_gui3.py py2app
#echo "ran setup script for Pmag GUI 3"
#rm -rf ../PmagPy-Standalone-OSX/pmag_gui.app
#echo "deleted old Pmag GUI"
#mv dist/pmag_gui3.app ..  #/PmagPy-Standalone-OSX
#echo "moved pmag_gui3.app " #to PmagPy-Standalone-OSX"
