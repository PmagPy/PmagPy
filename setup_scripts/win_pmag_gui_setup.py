...
distutils.core.setup(
    options = {
        "py2exe": {
            ...
            "includes": ["scipy", "scipy.special.*", "scipy.linalg.*", "scipy.linalg._decomp_update", "scipy.sparse.*", "scipy.sparse.csgraph.*", "scipy.ndimage", "scipy.ndimage.*", "scipy.linalg.cython_blas", "wx", "wx.lib.agw.floatspin", "wx.lib.scrolledpanel"],
