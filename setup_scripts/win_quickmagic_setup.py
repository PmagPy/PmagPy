...
help_data = glob.glob(os.path.join(directory, 'help_files') + os.path.sep + '*')
data_model = glob.glob(os.path.join(directory, 'data_model') + os.path.sep + '*')

img_files = [('images', [os.path.join(directory, 'images', 'PmagPy.ico')])]
