...
def main():
    ...
    for line in input.readlines():
        ...
        if linecnt == 1:
            ...
            if len(rec) == 5:
                SampRec["sample_bed_dip_direction"], SampRec["sample_bed_dip"] = '(%7.1f)' % (90. + float(rec[3])), (
                rec[4])
            ...
            if linecnt == 4:
                ...
                ResRec["result_description"] = 'Critical F: ' + hpars["F_crit"] + ';Critical F12/F13: ' + hpars[
                    "F12_crit"]
                ...
                if igeo == 1:
                    ...
                    ResRecG["result_description"] = 'Critical F: ' + hpars["F_crit"] + ';Critical F12/F13: ' + hpars[
                        "F12_crit"]
                ...
                if itilt == 1:
                    ...
                    ResRecT["result_description"] = 'Critical F: ' + hpars["F_crit"] + ';Critical F12/F13: ' + hpars[
                        "F12_crit"]
