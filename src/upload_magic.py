...
#   set up filenames to upload
    ...
    # read in the data
        ...
        if file_type != "bad_file":
            ...
            # check to only upload top priority orientation record!
            ...
            # only specimens that have sample names
            ...
            # only measurments that have specimen names
            if file_type == 'magic_measurments':
                NewData = []
                for rec in Data:
