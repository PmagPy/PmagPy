...
#
    ...
    #
                ...
                if nsteps > 2:
                    ...
                    # apply cooling rate correction
                    if nltrm == 0 and anis == 0 and cool != 0:
    ...
    #
                        ...
                        NltRecs = pmag.get_dictitem(
                            ...
                            'has')  # fish out all the NLT data for this specimen
                        if len(NltRecs) > 2:
    ...
    # check on anisotropy correction
                        ...
                        if len(AniSpecs) > 0:
                            ...
                            if crfrac != 0:
                                ...
                                # adjust specimen intensity by cooling rate
                                # correction
                                CrSpecRec["specimen_int"] = '%9.4e ' % (inten)
                                CrSpecRec[
                                    'magic_method_codes'] = CrSpecRec[
