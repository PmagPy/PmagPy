                ...
                if exp_type == "LP-PI-M-D":
                    ...
                    if GammaChecks != "":
                        ...
                        for gamma in GammaChecks:
                            if pmagplotlib.verbose:
                                print '%i %i %7.1f ' % (recnum, gamma[0], gamma[1])
                            recnum += 1
                        ...
                        try:
                            if PriorRecs[k]["er_specimen_name"] == s:
                                ...
                                for j in range(len(araiblock[0])):
                                    if float(araiblock[0][j][0]) == float(PriorRecs[k]["measurement_step_min"]):
                                        start = j
                                    if float(araiblock[0][j][0]) == float(PriorRecs[k]["measurement_step_max"]):
                                        end = j
                                ...
                                if errcode != 1:
                                    ...
                                    if len(trmblock) > 2:
                                        ...
                                        NLpars = nlt.NLtrm(
                                            ...
                                            best,
                                            blab,
                                            0)  # calculate best fit parameters through TRM acquisition data, and get new banc
                                        Mp, Bp = [], []
