...
def core_depthplot(meas_file='magic_measurements.txt', samp_file='er_samples.txt', depth_scale='sample_core_depth', sym='bo', size=5, method='LT-NO', fmt='svg', step=0, pltD=1, pltI=1, pltM=1, pltL=1, pltS=1):
