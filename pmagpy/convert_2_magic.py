...
def iodp_kly4s_lore(kly4s_file, meas_out='measurements.txt',
    ...
    specimens_df['dip']=0
    specimens_df['aniso_s_unit']="Normalized by trace"
...
# parse the measurement data into  columns
    measurements_df['susc_chi_volume']=in_df['Mean susceptibility(SI)']
    measurements_df['external_database_ids']='LORE['+in_df['Test No.'].astype('str')+']'
# parse specimen data into columns
    specimens_df['specimen_name_alternatives']=in_df['Text ID']
    s1=in_df['Normalized tensor K11']/3
    s2=in_df['Normalized tensor K22']/3
    s3=in_df['Normalized tensor K33']/3
    s4=in_df['Normalized tensor K12']/3
    s5=in_df['Normalized tensor K23']/3
    s6=in_df['Normalized tensor K13']/3
