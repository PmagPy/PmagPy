...
#============================================================================================
#
# 6/16/16 converted to data model 3.0 by Lisa Tauxe
#
...
class PI_Statistics_Dialog(wx.Dialog):
    ...
    def __init__(self, parent, show_statistics_on_gui,title):
        ...
        self.stat_by_category['Arai plot']=['int_n',
        'int_frac','int_f','int_fvds',
        'int_b_sigma','int_b_beta','int_scat',
        'int_g','int_gmax',
        'int_k','int_k_sse',
        'int_k_prime','int_k_prime_sse',
        'int_z','int_z_md',
        'int_q',
        'int_r2_corr','int_r2_det',      
        ]
        self.stat_by_category['Direction']=['int_mad_free','int_mad_anc','int_dang','int_alpha','int_alpha_prime','int_theta','int_crm','int_gamma']
        self.stat_by_category['pTRM Checks']=['int_n_ptrm','int_ptrm','int_drat','int_drats','int_cdrat','int_mdrat',
        'int_dck','int_maxdev','int_mdev','int_dpal']
        self.stat_by_category['Tail Checks']=['int_n_ptrm_tail','int_md','int_drat_tail','int_dtr','int_dt']
        self.stat_by_category['Additivity Checks']=['int_n_ac','int_dac']
        self.DESC={}
        self.DESC['int_frac']='The angle between the applied field direction and the ChRM direction of the NRM as determined from the free-floating PCA fit to the selected demagnetization steps of the paleointensity experiment'
        ...
        self.DESC['int_f']='NRM fraction used for the best-fit on an Arai plot '
        self.DESC['int_fvds']='NRM fraction used for the best-fit on an Arai plot calculated as a vector difference sum'
        self.DESC['int_b']='The slope of the best-fit line of the selected TRM and NRM points on an Arai plot'
        self.DESC['int_b_sigma']='The standard error on the slope on an Arai plot'
        self.DESC['int_b_beta']='The ratio of the standard error of the slope to the absolute value of the slope on an Arai plot'
        self.DESC['int_g']='The gap reflects the average spacing of the selected Arai plot points along the best-fit line'
        self.DESC['int_gmax']='The maximum gap between two points in Arai plot determined by vector arithmetic'
        self.DESC['int_r2_corr']='The squared correlation coefficient to estimate the strength of the linear relationship between the NRM and TRM over the best-fit Arai plot segment'
        self.DESC['int_r2_det']='The squared coefficient of determination to estimate variance accounted for by the linear model fit on an Arai plot'
        self.DESC['int_dang']='The angle between the free-floating best-fit direction and the vector connecting the center of mass and the origin of the vector component diagram'
        self.DESC['int_crm']='The cumulative deflection between the NRM vectors and the ChRM direction'
        self.DESC['int_n_ptrm_tail']='Number of pTRM tail checks used in paleointensity experiment'
        self.DESC['int_md']='Maximum absolute difference produced by a pTRM tail check, normalized by the vector difference sum of the NRM'
        self.DESC['int_drat_tail']='Maximum absolute difference produced by a pTRM tail check, normalized by the length of the best-fit line'
        self.DESC['int_dtr']='Maximum absolute difference produced by a pTRM tail check, normalized by the NRM (obtained from the intersection of the best-fit line and the y-axis on an Arai plot)'
        self.DESC['int_n_ptrm']='Number of pTRM checks used in paleointensity experiment'
        self.DESC['int_ptrm']='Maximum absolute difference produced by a pTRM check, normalized by the TRM acquired at that heating step'
        self.DESC['int_dck']='Maximum absolute difference produced by a pTRM check, normalized by the total TRM (obtained from the intersection of the best-fit line and the x-axis on an Arai plot)'
        self.DESC['int_maxdev']='Maximum absolute difference produced by a pTRM check, normalized by the length of the TRM segment of the best-fit line on an Arai plot'
        self.DESC['int_drat']='Maximum absolute difference produced by a pTRM check, normalized by the length of the best-fit line'
        self.DESC['int_mdrat']='The average difference produced by a pTRM check, normalized by the length of the best-fit line'
        self.DESC['int_cdrat']='Cumulative difference ratio difference produced by a pTRM check'
        self.DESC['int_drats']='Cumulative pTRM check difference normalized by the pTRM gained at the maximum temperature used for the best-fit on the Arai plot'
        self.DESC['int_mdev']='Mean deviation of a pTRM check'
        self.DESC['int_dpal']='A measure of cumulative alteration determined by the difference of the alteration corrected intensity estimate (Valet et al., 1996) and the uncorrected estimate, normalized by the uncorrected estimate (Leonhardt et al., 2004a)'
        self.DESC['int_dt']='The extent of a pTRM tail after correction for angular dependence'
        self.DESC['int_dac']='The maximum absolute additivity check difference normalized by the total TRM (obtained from the intersection of the best-fit line and the x-axis on an Arai plot'
        self.DESC['int_ac_n']='The number of additivity checks used to analyze the best-fit segment on an Arai plot'
        self.DESC['int_k']='The curvature of the Arai plot as determined by the best-fit circle to all of the data '
        self.DESC['int_k_sse']='The quality of the best-fit circle used to determine k'
        self.DESC['int_k_prime']='The curvature of the Arai plot as determined by the best-fit circle to the selected data points'
        self.DESC['int_k_prime_sse']='The quality of the best-fit circle used to determine k_prime'
        self.DESC['int_z']='Arai plot zigzag parameter calculated using the scatter around the best-fit slope on an Arai plot'
        self.DESC['int_z_md']='Arai plot zigzag parameter calculated by the area bounded by the curve that the ZI points make and the curve that the IZ points make'
        self.DESC['int_scat']='All pTRM checks, MD checks, IZ ZI data, etc. are in the box (g = good or b=bad)'
        self.DESC['int_viscosity_index']='Viscosity index'
        self.DESC['treat_dc_field']='Applied DC field in laboratory'
        self.DESC['treat_ac_field']='Applied maximum or peak AC field in laboratory'
        self.DESC['magn_moment']='Measured magnetic moment'
        self.DESC['magn_volume']='Measured intensity of magnetization, Volume normalized'
        self.DESC['magn_mass']='Measured intensity of magnetization, Mass normalized'
        self.DESC['int_corr_cooling_rate']='Cooling rate correction factor for intensity'
        self.DESC['int_corr_anisotropy']='Anisotropy correction factor for intensity'
        self.DESC['int_corr_nlt']='Non-linear TRM correction factor for intensity'
        self.DESC['int_delta']='Maximum angle of deviation between assumed NRM and measured NRM in perpendicular paleointensity method'
        self.DESC['int_theta']='The angle between the applied field direction and the ChRM direction of the NRM as determined from the free-floating PCA fit to the selected demagnetization steps of the paleointensity experiment'
        self.DESC['int_gamma']='Maximum angle of deviation between acquired pTRM direction and assumed applied field direction'
        self.InitUI()
...
class MyForm(wx.Frame):
    ...
    def __init__(self,number_of_rows_to_ignore,file_name):
        ...
        for i in range(1+number_of_rows_to_ignore,len(self.report)):
          ...
          index+=1
        self.myGrid.SetLabelFont(wx.Font(9, wx.SWISS, wx.NORMAL, wx.NORMAL, False, 'Arial'))
        self.myGrid.SetDefaultCellFont(wx.Font(9, wx.SWISS, wx.NORMAL, wx.NORMAL, False, 'Arial'))
...
class Consistency_Test(wx.Frame):
    ...
    def On_close_fixed_criteria_box(self,dia):
        ...
        if dia.set_average_by_sample_or_site.GetValue()=='sample':
            for crit in ['sites.int_n','sites.int_sigma','sites.int_sigma_perc','sites.aniso_mean','sites.int_n_outlier_check']:
                self.acceptance_criteria[crit]['value']=-999
        if dia.set_average_by_sample_or_site.GetValue()=='site':
            for crit in ['samples.int_n','samples.int_sigma','samples.int_sigma_perc','samples.aniso_mean','samples.int_n_outlier_check']:
                self.acceptance_criteria[crit]['value']=-999
        ...
        for i in range(len(criteria_list)):            
            ...
            if dia.set_average_by_sample_or_site.GetValue()=='sample':
                if crit in ['sites.int_n','sites.int_sigma','sites.int_sigma_perc','sites.aniso_mean','sites.int_n_outlier_check']:
                    continue
            if dia.set_average_by_sample_or_site.GetValue()=='site':
                if crit in ['samples.int_n','samples.int_sigma','samples.int_sigma_perc','samples.aniso_mean','samples.int_n_outlier_check']:
                    continue
            #------
            if crit in ['sites.int_n','sites.int_sigma_perc','sites.aniso_mean','sites.int_n_outlier_check']:
                command="value=dia.set_%s.GetValue()"%crit.replace('site','sample')                
            
            elif crit=='samples.int_sigma' or crit=='sites.int_sigma':
            ...
            if type(value)==bool and value==True:
               ...
               if  crit=='samples.int_sigma' or crit=='sites.int_sigma':
        ...
        if result == wx.ID_OK:
            ...
            #except:
            #    pass
            ofile = os.path.join(self.WD, "consistency_test/fixed_criteria.txt")
...
class convert_generic_files_to_MagIC(wx.Frame):
    ...
    def InitUI(self):
        ...
        bSizer1.AddSpacer(5)
        for i in range(self.max_files):
            command="self.protocol_info_%i = wx.ComboBox(self.panel, -1, self.experiments[0], size=(100,25), choices=self.experiments, style=wx.CB_DROPDOWN)"%i
        ...
        self.sample_naming_conventions=['sample=specimen','no. of terminalcharacters','character delimited']
        bSizer4.AddSpacer(5)
        for i in range(self.max_files):
        ...
        self.site_naming_conventions=['site=sample','no. of terminal characters','character delimited']
        bSizer5.AddSpacer(5)
        for i in range(self.max_files):
    ...
    def on_okButton(self,event):
        ...
        # prepare output file
        magic_headers=['citations','specimen',"sample","site",'location','analysts',\
                       "instrument_codes","flag","standard","experiment","method_codes","number",'treat_temp',"dir_dec","dir_inc",\
                       "magn_moment","meas_temp","treat_dc_field","treat_dc_field_phi","treat_dc_field_theta"]             

        fout=open("measurements.txt",'w')        
        fout.write("tab\tmeasurements\n")
        header_string=""
        ...
        for i in range(self.max_files):
            ...
            for specimen in list(this_file_data.keys()):
                ...
                for meas_line in this_file_data[specimen]:
                    MagRec={}
                    #
                    MagRec["specimen"]=meas_line['Specimen']
#
#   NOW THAT SPECIMENS ARE TIED TO SAMPLES AND SAMPLES TO SITES IN THE SPECIMENS.TXT AND SAMPLES.TXT FILES RESPECTIVELY, SHOULD WE CREATE THOSE HERE?
#
                    MagRec['citations']="This study"
                    MagRec['analysts']=user_name 
                    MagRec["instrument_codes"]="" 
                    MagRec["flag"]='g'
                    MagRec["number"]="%i"%measurement_running_number
                    MagRec['treat_temp']="%.2f"%(float(meas_line['Treatment'].split(".")[0])+273.)
                    MagRec["dir_dec"]=meas_line["Declination"]
                    MagRec["dir_inc"]=meas_line["Inclination"]
                    MagRec["magn_moment"]='%10.3e'%(float(meas_line["Moment"])*1e-3) # in Am^2
                    MagRec["meas_temp"]='273.' # room temp in kelvin
                    MagRec["treat_dc_field"]='%8.3e'%(float(labfield[0])*1e-6)
                    MagRec["treat_dc_field_phi"]="%.2f"%(float(labfield[1]))
                    MagRec["treat_dc_field_theta"]="%.2f"%(float(labfield[2]))
                    MagRec["standard"]="u"
                    MagRec["experiment"]=MagRec["er_specimen_name"]+":"+Magic_lab_protocols[experiment]
                    ...
                    MagRec["method_codes"]=lab_treatment+":"+lab_protocols_string
                    line_string=""
                    for i in range(len(magic_headers)):
