...
More documentation can be found at the PmagPy documentation site:
...
DESCRIPTION
    ...
    For a tutorial see the PmagPy documentation: https://pmagpy.github.io/PmagPy-docs/programs/thellier_gui.html
