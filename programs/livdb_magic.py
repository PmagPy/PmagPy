...
# hbox.AddSpacer(5)
    ...
    def on_okButton(self, event):
        ...
        for i in range(self.max_files):
            ...
            self.convert_2_magic(dir_name, meas_out, spec_out,
                                 samp_con, samp_chars, site_con,
                                 site_chars, location_name)
            meas_files.append(meas_out)
            spec_files.append(spec_out)

        res = ipmag.combine_magic(meas_files, "magic_measurements.txt")
        ipmag.combine_magic(spec_files, "er_specimens.txt")
    ...
    def after_convert_dia(self):
        dlg1 = wx.MessageDialog(
            None, caption="Message:", message="file converted to magic_measurements.txt\n you can try running thellier gui...\n", style=wx.OK | wx.ICON_INFORMATION)
        dlg1.ShowModal()
        dlg1.Destroy()
        self.Destroy()
    ...
    # refactor like this:
    #convert_2_magic(dir_path, samp_name_con=1, samp_num_chars=0, site_name_con=1, site_num_chars=0, location_name="")
    # then run combine_magic to put all of these together
                    ...
                    for Experiment_Type in Experiment_Types_list:
                        ...
                        if Experiment_Type in supported_experiments:
                            ...
                            for i in range(len(Data[specimen][Experiment_Type]['meas_data'])):
                                ...
                                MagRec["magic_experiment_name"] = specimen + \
                                    ":"+lab_protocols_string
                    ...
                    for Experiment_Type in Experiment_Types_list:
                        ...
                        if Experiment_Type in supported_experiments:
                            ...
                            ErRec["er_site_name"] = self.get_site_name(
                                MagRec["er_sample_name"], [site_name_con, site_num_chars])
                            ErRec['er_location_name'] = location_name
