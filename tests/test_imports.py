...
class Test_sio_magic(unittest.TestCase):
    ...
    def test_sio_magic_success(self):
        options = {}
        options['mag_file'] = os.path.join(WD, 'pmag_data_files',
                                           'Measurement_Import', 'sio_magic',
                                           'sio_af_example.dat')
        meas_file = os.path.join(WD, 'pmag_data_files', 'Measurement_Import',
...
class Test_cit_magic(unittest.TestCase):
    ...
    def test_cit_magic_with_file(self):
        options = {}
        options['input_dir_path'] = os.path.join(WD, 'pmag_data_files',
                                                 'Measurement_Import',
                                                 'cit_magic', 'MP18')
...
class Test_iodp_srm_magic(unittest.TestCase):
    ...
    def test_iodp_with_files(self):
        options = {}
        dir_path = os.path.join(WD, 'pmag_data_files', 'Measurement_Import',
                                'iodp_srm_magic')
    ...
    def test_iodp_with_one_file(self):
        ...
        #dir_path = os.path.join(WD, 'pmag_data_files', 'Measurement_Import',
        # 'iodp_srm_magic')
        dir_path = os.path.join(WD, 'pmag_data_files', 'UTESTA', 'SRM_data')
...
class Test_iodp_jr6_magic(unittest.TestCase):
    ...
    def tearDown(self):
        ...
        input_dir = os.path.join(WD, 'pmag_data_files', 'Measurement_Import',
                                 'iodp_jr6_magic')
...
class Test2g_bin_magic(unittest.TestCase):
    ...
    def test_2g_with_files(self):
        options = {}
        options['ID'] = os.path.join(WD, 'pmag_data_files', 'Measurement_Import',
                                     '2g_bin_magic', 'mn1')
...
class Test_bgc_magic(unittest.TestCase):
    ...
    def setUp(self):
        self.input_dir = os.path.join(WD, 'pmag_data_files',
